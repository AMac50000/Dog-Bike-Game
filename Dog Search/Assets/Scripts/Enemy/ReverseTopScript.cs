...
public class ReverseTopScript : MonoBehaviour
{
    ReverseEnemyScript reScript;

    private void Start()
    {
        reScript = transform.parent.gameObject.GetComponent<ReverseEnemyScript>();
    }
